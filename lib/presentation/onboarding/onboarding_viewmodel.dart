...
class OnBoardingViewModel extends BaseViewModel
  ...
  late final List<SliderObjectEntity> _list;
  ...
  // private functions
  List<SliderObjectEntity> _getSliderData() => [
        SliderObjectEntity(AppStrings.onBoardingTitle1.tr(),
            AppStrings.onBoardingSubTitle1.tr(), ImageAssets.onboardingLogo1),
        SliderObjectEntity(AppStrings.onBoardingTitle2.tr(),
            AppStrings.onBoardingSubTitle2.tr(), ImageAssets.onboardingLogo2),
        SliderObjectEntity(AppStrings.onBoardingTitle3.tr(),
            AppStrings.onBoardingSubTitle3.tr(), ImageAssets.onboardingLogo3),
        SliderObjectEntity(AppStrings.onBoardingTitle4.tr(),
...
class SliderViewObject {
  SliderObjectEntity sliderObject;
  int numOfSlides;
  int currentIndex;
